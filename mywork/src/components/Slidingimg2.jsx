  ...
  return (
    <div >
        ...
        containerClass="carousel-container"
         ...
         autoPlaySpeed={10000}
         >
             <div className={styles.imgslide}><img src="https://img.faballey.com/images/Product/DRS04733Z/1.jpg"/>
             <p className={styles.productname}>Yellow Summer Dresss</p>
             <p className={styles.productprice}><FaRupeeSign/>1444</p></div>
            <div className={styles.imgslide}><img src="https://img.faballey.com/images/Product/TOP05745Z/1.jpg"/>
            <p className={styles.productname}>White Satin Strappy Textured Top</p>
            <p className={styles.productprice}><FaRupeeSign/>567</p></div>
            <div className={styles.imgslide}><img src="https://img.faballey.com/images/Product/TOP05590Z/1.jpg"/>
            <p className={styles.productname}>Black Embellished Cutout Top</p>
            <p className={styles.productprice}><FaRupeeSign/>1299</p></div>
            <div className={styles.imgslide}><img src="https://img.faballey.com/images/Product/DRS04820Z/1.jpg"/>
            <p className={styles.productname}>Multi Color Poplin Dress</p>
            <p className={styles.productprice}><FaRupeeSign/>999</p></div>
            <div className={styles.imgslide}><img src="https://img.faballey.com/images/Product/DRS04857Z/1.jpg"/>
            <p className={styles.productname}>Pink Floral Jumpsuit</p>
            <p className={styles.productprice}><FaRupeeSign/>1444</p></div>
            <div className={styles.imgslide}><img src="https://img.faballey.com/images/Product/DRS04837Z/1.jpg"/>
            <p className={styles.productname}>Pink Smocky Dress</p>
            <p className={styles.productprice}><FaRupeeSign/>799</p></div>
            <div className={styles.imgslide}><img src="https://img.faballey.com/images/Product/BOT00601A/1.jpg"/>
            <p className={styles.productname}>Wine Skinny Leggins</p>
            <p className={styles.productprice}><FaRupeeSign/>1199</p></div>
            <div className={styles.imgslide}><img src="https://img.faballey.com/images/Product/DRS04856Z/1.jpg"/>
