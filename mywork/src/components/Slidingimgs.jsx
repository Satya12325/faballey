  ...
  return (
    <div >
        ...
        containerClass="carousel-container"
         ...
         autoPlaySpeed={10000}
         >
             <div className={styles.imgslide}><img src="https://img.faballey.com/images/Product/FCO00076Z/1.jpg"/>
             <p className={styles.productname}>Black Top and Pant Set</p>
             <p className={styles.productprice}><FaRupeeSign/>1444</p></div>
            <div className={styles.imgslide}><img src="https://img.faballey.com/images/Product/FCO00016Z/1.jpg"/>
            <p className={styles.productname}>Black Crop Top</p>
            <p className={styles.productprice}><FaRupeeSign/>567</p></div>
            <div className={styles.imgslide}><img src="https://img.faballey.com/images/Product/CTP00625D/1.jpg"/>
            <p className={styles.productname}>CURVE Floral Lace Top</p>
            <p className={styles.productprice}><FaRupeeSign/>1299</p></div>
            <div className={styles.imgslide}><img src="https://img.faballey.com/images/Product/TOP05792Z/1.jpg"/>
            <p className={styles.productname}>Floral Garden Top</p>
            <p className={styles.productprice}><FaRupeeSign/>999</p></div>
            <div className={styles.imgslide}><img src="https://img.faballey.com/images/Product/DRS04752Z/1.jpg"/>
            <p className={styles.productname}>Rainbow Dress</p>
            <p className={styles.productprice}><FaRupeeSign/>1444</p></div>
            <div className={styles.imgslide}><img src="https://img.faballey.com/images/Product/TOP05768Z/1.jpg"/>
            <p className={styles.productname}>Floral Purple Top</p>
            <p className={styles.productprice}><FaRupeeSign/>799</p></div>
            <div className={styles.imgslide}><img src="https://img.faballey.com/images/Product/TOP05767Z/1.jpg"/>
            <p className={styles.productname}>Pink Chiffon Top</p>
            <p className={styles.productprice}><FaRupeeSign/>1199</p></div>
            <div className={styles.imgslide}><img src="https://img.faballey.com/images/Product/TOP05773Z/1.jpg"/>
            <p className={styles.productname}>Green Top With Straps</p>
            <p className={styles.productprice}><FaRupeeSign/>899</p></div>
            <div className={styles.imgslide}><img src="https://img.faballey.com/images/Product/DRS04878Z/1.jpg"/>
